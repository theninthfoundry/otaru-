...
export const MOCK_ARTIFACTS: Artifact[] = [
  {
    ...
    description: "13oz Japanese selvedge denim, hand-finished brass hardware.",
    descriptionHtml:
    ...
    compareAtPrice: null,
    featuredImage: { url: placeholderImage("chore-coat-1"), altText: "Raw Denim Chore Coat, front", width: 1200, height: 1500 },
    images: [
  ...
  },
  {
    ...
    description: "Architectural silhouette in double-face Italian wool.",
    descriptionHtml:
    ...
    featuredImage: { url: placeholderImage("overcoat-1"), altText: "Structured Wool Overcoat, front", width: 1200, height: 1500 },
    images: [
    ...
    availableForSale: true,
    seo: { title: "Structured Wool Overcoat", description: "Architectural silhouette in wool." },
  },
  {
    id: "gid://mock/Product/3",
    handle: "kinetic-cargo-trouser",
    title: "Kinetic Cargo Trouser",
    description: "Articulated knee construction in a matte technical twill.",
    descriptionHtml:
    ...
    compareAtPrice: null,
    featuredImage: { url: placeholderImage("cargo-1"), altText: "Kinetic Cargo Trouser, front", width: 1200, height: 1500 },
    images: [
...
export const MOCK_CHAPTERS: Chapter[] = [
  {
    ...
    coverImage: {
      _type: 'image',
      asset: { _ref: "image-chapter-02", _type: "reference" },
      alt: "Chapter 02 hero",
    },
  },
];
...
export const MOCK_JOURNAL: JournalEntry[] = [
  {
    ...
    coverImage: {
      _type: 'image',
      asset: { _ref: "image-journal-01", _type: "reference" },
    },
    author: "Otaru Studio",
    body: [],
