        ...
        {cart.lines.length > 0 && (
          <div className="space-y-4 pt-4">
            ...
            <Link
              href="/checkout"
              onClick={closeDrawer}
              className="flex h-12 w-full items-center justify-center rounded-sm bg-otaru-ink text-body-md text-otaru-chalk hover:opacity-90 transition-opacity duration-1"
            >
              Checkout
            </Link>
          </div>
