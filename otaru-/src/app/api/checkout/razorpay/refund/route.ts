/**
 * OTARU — Razorpay Refund API
 *
 * Security layers applied:
 *  1. Payment-Tier Rate Limiter (2 refunds per IP per hour)
 *  2. Zod Schema Validation
 *  3. Transaction State Validation (must be CAPTURED, not already REFUNDED)
...
export async function POST(request: Request) {
  ...
  try {
    ...
    // ── Step 3: Transaction State Validation ──────────────────────────────────
