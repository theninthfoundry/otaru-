...
interface UseMagneticOptions {
  /** Attraction radius in pixels. Default: 40 */
  radius?: number;
  /** Strength of magnetic pull (0–1). Default: 0.35 */
  strength?: number;
  /** Return spring speed. Default: 0.15 */
  returnSpeed?: number;
}
...
/**
 * Magnetic button effect — element subtly follows the cursor
 * when within a configurable radius.
 *
 * @example
 * const { ref } = useMagnetic<HTMLButtonElement>();
 * <button ref={ref}>Explore</button>
 */
