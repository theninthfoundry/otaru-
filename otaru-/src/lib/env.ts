/**
 * OTARU — Environment Variable Validation Module
 *
 * Validates mandatory server and client environment variables at runtime
 * and provides clean diagnostic warnings for optional integration keys.
 */

import { z } from 'zod';

const envSchema = z.object({
  // Required Shopify & Sanity Config
  ...
  // Optional Analytics & Marketing Keys
...
}) as any; // Cast schema to prevent strict validation issues with legacy env configs
...
export function validateEnv(): Env {
  ...
  // Diagnostic warnings for missing operational keys
