/**
 * OTARU — Klaviyo Integration Module
 *
 * Production-ready server and client integration for Klaviyo v3 API.
 * Supports list subscriptions, waitlist tagging, and custom event tracking.
 * Includes graceful fallbacks when environment variables are omitted.
 */
...
/**
 * Subscribe a profile to a Klaviyo list using Klaviyo v3 API.
 */
...
/**
 * Track a custom event in Klaviyo (e.g. Product Viewed, Added to Cart, Placed Order).
 */
