/**
 * OTARU — Design Tokens (TypeScript)
 *
 * JS-accessible versions of the CSS custom property tokens.
 * Used in Framer Motion configs, dynamic calculations, and
 * anywhere CSS variables aren't directly accessible.
 */
