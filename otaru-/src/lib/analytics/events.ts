/**
 * OTARU — Analytics Funnel Event Tracking
 *
 * Typed analytics events for GA4, Meta Pixel (fbq), Microsoft Clarity, and PostHog.
 */
...
/**
 * Track Begin Checkout initiation.
 */
