...
// Minimal Web NFC type surface — not yet in lib.dom.d.ts.
...
/**
 * Web NFC tap-to-verify. Only supported on Chrome for Android over HTTPS —
 * feature-detects and hides itself everywhere else. On a successful tap,
 * expects the tag to encode a URL of the form /verify?serial=XXXX and
